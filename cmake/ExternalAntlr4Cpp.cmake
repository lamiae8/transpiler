...
set(ANTLR4CPP_EXTERNAL_ROOT /home/lamiae/Downloads/antlr4/runtime/Cpp/antlr4cpp) #pointing to the antlr4 runtime 


# external repository
# GIT_REPOSITORY     https://github.com/antlr/antlr4.git
#set(ANTLR4CPP_EXTERNAL_REPO "https://github.com/adeharo9/antlr4-cpp-runtime")
...
ExternalProject_ADD(
  ...
  #--Core-directories-----------
  PREFIX            
  SOURCE_DIR        /home/lamiae/Downloads/antlr4/runtime/Cpp/	
  #--Download step--------------
  ...
  # PATCH_COMMAND sh -c "cp <SOURCE_DIR>/scripts/CMakeLists.txt <SOURCE_DIR>"
  #--Configure step-------------
  #CONFIGURE_COMMAND  ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Release -DANTLR4CPP_JAR_LOCATION=${ANTLR4CPP_JAR_LOCATION} -DBUILD_SHARED_LIBS=ON -DBUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_SOURCE_DIR:PATH=<SOURCE_DIR>/runtime/ <SOURCE_DIR>/runtime/
#  LOG_CONFIGURE ON
  #--Build step-----------------
...
ExternalProject_Get_Property(antlr4cpp SOURCE_DIR)

#add_subdirectory(/home/ubuntu/Desktop/antlr4/runtime/Cpp antlr4cpp) 
#add_library(antlr4cpp /home/ubuntu/Desktop/antlr4/runtime/Cpp/)


#add_library(/home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.so.4.7.1)
#add_library(home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.a)

#target_link_libraries(antlr4_shared /home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.so.4.7.1)
#target_link_libraries(antlr4_static /home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.a)
...
#set(antlr4_shared /home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.so.4.7.1)
#set(antlr4_static /home/ubuntu/Desktop/transpiler/build3/externals/antlr4cpp/lib/libantlr4-runtime.a)
